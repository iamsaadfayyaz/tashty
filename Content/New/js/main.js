...
(function ($) {
    ...
    try {
        ...
        $('.btn-show-menu-mobile-admin').on('click', function () {
            //debugger
            $(this).toggleClass('is-active');
            $('.menu-mobile').slideToggle();
        });
        $('.seller-fullclick').on('click', function () {
            $('.seller-sub-menu-m').css('display', 'block');


        });

        $('.clicktaga').on('click', function () {
            $('.ct-sub-menu-m').css('display', 'block');
            

        });
        $('.seller-clicktaga').on('click', function () {
            $('.seller-sub-menu-m').css('display', 'block');
        ...
        $('.menu-mobile ul li a').on('click', function () {
            debugger
            if ($(this).hasClass('clicktaga') || $(this).hasClass('seller-clicktaga') || $(this).hasClass('seller-fullclick')) {
                return false;
            }
            else {
        ...
        $(window).on('resize', function () {
            if ($(window).width() >= 992) {
                if ($('.menu-mobile').css('display') === 'block') {
                    ...
                    $('.btn-show-menu-mobile-admin').toggleClass('is-active');
                }
